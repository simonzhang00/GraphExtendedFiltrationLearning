...
from gnn.proteins_model import PershomLearnedFilt, PershomLearnedFiltSup, PershomRigidDegreeFilt, GIN, SimpleNNBaseline, ClassicGNN, ClassicReadoutFilt
...
if __name__ == "__main__":
    ...
    parser.add_argument('--exp_name', type= str, default= 'protein', help= 'experiment name to save as')
    ...
    parser.add_argument('--filt_conv_number', type=int, default=2)
    ...
    parser.add_argument('--num_struct_elements', type=int, default=64)
