...
class ClassicGNN(torch.nn.Module):
    def __init__(self,
        ...
        if use_raw_node_label and not num_node_lab==0:
...
class Filtration(torch.nn.Module):
    def __init__(self,
        ...
        self.embed_lab = nn.Embedding(num_node_lab, dim) if (use_node_label and not use_raw_node_label and not (
                    num_node_lab == 0 or num_node_lab is None)) else None
        self.use_raw_node_label = use_raw_node_label
